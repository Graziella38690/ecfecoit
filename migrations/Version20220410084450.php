 ...
 */
final class Version20220410084450 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_F87474F3CDF80196 ON lesson');
        $this->addSql('ALTER TABLE lesson CHANGE lesson_id section_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE lesson CHANGE section_id lesson_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE lesson ADD CONSTRAINT FK_F87474F3CDF80196 FOREIGN KEY (lesson_id) REFERENCES section (id)');
        $this->addSql('CREATE INDEX IDX_F87474F3CDF80196 ON lesson (lesson_id)');
    }
}
