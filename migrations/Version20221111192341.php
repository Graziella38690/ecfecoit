...
final class Version20221111192341 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE training (id INT AUTO_INCREMENT NOT NULL, creatby_id INT DEFAULT NULL, section_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, datecreation DATE NOT NULL, catchphrase LONGTEXT NOT NULL, INDEX IDX_D5128A8F4EB34D16 (creatby_id), INDEX IDX_D5128A8FD823E37A (section_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
